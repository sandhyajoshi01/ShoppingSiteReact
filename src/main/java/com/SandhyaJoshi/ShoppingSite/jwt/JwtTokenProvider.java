...
public class JwtTokenProvider {
    ...
    //call jwt from application properties
    ...
    //Authentication class keeps the roles of the authenticated users
    ...
    //parsing token value to get username and password
    public Authentication getAuthentication(HttpServletRequest request){
        ...
        final List<GrantedAuthority> authorities = Arrays.stream(claims.get("roles").toString().split(","))
                .map(role -> role.startsWith("ROLE_")?role:"ROLE_"+role)  //role prefix to be added for authentication
    ...
    //checking the validation of token
